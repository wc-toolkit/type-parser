...
- 2fc0bb2: Resolve `parsedType` for members declared on a Lit-style mixin.
...
- fbceecc: Export `getTypeChecker()` and `getProgram()` accessor functions for use in custom CEM plugins (fixes #10).
